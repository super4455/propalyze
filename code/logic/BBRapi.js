...
async function hentBBR(dawaData) {
 ...
 if (erLejlighed) {
   ...
   // Kald 2: Hent bygning for byggeår, grundareal og etager
   ...
   if (bygSvar.ok) {
     ...
     if (bygData.length > 0) {
       resultat.byggeaar = bygData[0].byg026Opførelsesår;
       resultat.grundareal = bygData[0].byg038SamletBygningsareal;
       resultat.antalEtager = bygData[0].byg054AntalEtager;
     }
   }
